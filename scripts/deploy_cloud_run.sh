...
LOOKER_ENV_VARS="LOOKER_BASE_URL=${LOOKER_BASE_URL},LOOKER_VERIFY_SSL=${LOOKER_VERIFY_SSL},LOOKER_USE_CLIENT_OAUTH=${LOOKER_USE_CLIENT_OAUTH}"
if [ -n "${LOOKER_UI_URL}" ]; then
  LOOKER_ENV_VARS="${LOOKER_ENV_VARS},LOOKER_UI_URL=${LOOKER_UI_URL}"
fi
